    ...
    return (
      <div className="container">
        ...
        <div className="palette-row palette-row-4">
          <h4>Complimentary: Blue business</h4>
          <div className="palette-container">
            <div className="palette-wrapper">
              <div className="color-box box-1"></div>
            ...
            <div className="palette-wrapper">
              <div className="color-box box-4"></div>
              <p className="color-label">#FFE1B9</p>
            </div>
          </div>
        </div>
        {/* Palett nr 5 */}
        ...
        <div className="palette-row palette-row-6">
          ...
          <div className="palette-container">
            ...
            <div className="palette-wrapper">
              <div className="color-box box-3"></div>
              <p className="color-label">#B3604B</p>
            </div>
            <div className="palette-wrapper">
              <div className="color-box box-4"></div>
              <p className="color-label">#FCDCD6</p>
            </div>
          </div>
        </div>
